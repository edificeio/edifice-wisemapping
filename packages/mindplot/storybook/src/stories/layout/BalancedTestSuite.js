...
class BalancedTestSuite extends TestSuite {
  ...
  testBalancedPredict() {
    ...
    // Graph 1
    const graph1 = manager.plot('testBalancedPredict1', { width: 1000, height: 400 });
    ...
    const graph3 = manager.plot('testBalancedPredict3', { width: 1000, height: 400 });
    ...
    manager.layout();
    const graph4 = manager.plot('testBalancedPredict4', { width: 1000, height: 400 });
  ...
  testBalancedNodeDragPredict() {
    ...
    manager.layout();
    const graph1 = manager.plot('testBalancedNodeDragPredict1', { width: 800, height: 400 });
    ...
    manager.layout();
    const graph2 = manager.plot('testBalancedNodeDragPredict2', { width: 800, height: 400 });
    ...
    manager.layout();
    const graph3 = manager.plot('testBalancedNodeDragPredict3', { width: 800, height: 400 });
